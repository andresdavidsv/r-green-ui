...
const Ficha = (props) => {
    ...
    return(
        ...
        <div className='h-full bg-cover bg-center h-auto py-24 px-10 object-fill bg-black bg-opacity-25	' >
            <div className='w-full p-8 mt-80 rounded-md' style={{backgroundColor: '#f5fef4b8'}}>
                <p className=' font-bold text-sm uppercase text-green-400'>{props.txt_uno}</p>
                <p className='mb-2 text-3xl font-bold text-green-900'>{props.txt_dos}</p>
                <p className='text-2xl mb-10 text-gray-700'>{props.txt_tres}</p>
