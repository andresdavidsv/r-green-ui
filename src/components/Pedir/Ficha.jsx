...
const Ficha = (props) => {
    ...
    return(
       ...
       // <section className='inline-block bg-center h-full' style={{  backgroundImage: `url("https://via.placeholder.com/500")` }}>

        

            <div className='w- bg-cover bg-center h-auto py-24 px-10 object-fill' >
