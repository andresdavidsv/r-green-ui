...
const Profile = () => (
  <section className="w-full">
    <section className="w-auto relative m-15 shadow-2xl rounded-3xl  overflow-hidden">
      ...
      <div id="section1"
        className="col-span-12 md:border-solid md:border-l md:border-black md:border-opacity-25 h-full pb-12  md:col-span-10 pr-10 pl-3">
        <div className="px-4 pt-4">
          <form className="flex flex-col space-y-8">

            <div>
              <h3 className="text-2xl font-semibold">Inicio</h3>
            </div>

            <div className="form-item">
              <label className="text-xl ">Nombre completo</label>
              <input type="text" value="R-green organitation" className="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2  mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200"
                disabled />
            </div>
            ...
            <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
              ...
              <div className="form-item w-full">
                ...
                <input type="text" value="r_green@gmail.com" className="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25 "
                  disabled />
              </div>
            </div>

            <div>
              <h3 className="text-2xl font-semibold ">Más información</h3>
            </div>
            ...
            <div>
              <h3 className="text-2xl font-semibold">Nuestras redes sociales</h3>
            </div>
                ...
                <div className="col-span-11">
                  <div className="form-item h-20">
                    ...
                    <input type="text" value="https://linkedin.com/"
                      className="w-full pt-2 appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25"
                      disabled />
                  </div>
                </div>
              </div>
                ...
                <div className="col-span-11">
                  <div className="form-item">
                    ...
                    <input type="text" value="https://instagram.com/"
                      className="w-full appearance-none text-black text-opacity-50 rounded shadow focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25"
                      disabled />
                  </div>
                </div>
              </div>
